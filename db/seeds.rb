...
Chore.create(chore_name: '洗濯', user_id: 1 )
Chore.create(chore_name: 'ゴミ捨て', user_id: 1)
Chore.create(chore_name: '風呂掃除', user_id: 1)
Chore.create(chore_name: 'トイレ掃除', user_id: 1)
Chore.create(chore_name: '食後の片付け', user_id: 1)
Chore.create(chore_name: '子の入浴補助', user_id: 1)
Chore.create(chore_name: '子の食事補助', user_id: 1)
Chore.create(chore_name: '子の登園準備', user_id: 1)
